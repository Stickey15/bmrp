-- Framework related
impulse.Config.SchemaName = "Black Mesa Roleplay"
impulse.Config.SchemaVersion = "1.0.0"
impulse.Config.SchemaCredits = [[<font=Impulse-Elements23>Stickey</font>]]

impulse.Config.MainColour = Color(245, 139, 0, 255)
impulse.Config.InteractColour = Color(251, 197, 49)

impulse.Config.UserSlots = 128 -- any other slots will be donator slots

impulse.Config.IntroMusic = "music/hl2_song3.mp3"
...
impulse.Config.OOCLimit = 30
impulse.Config.OOCLimitVIP = 50
...
impulse.Config.QuizWaitTime = 0 -- in mins

impulse.Config.RespawnTime = 0
impulse.Config.RespawnTimeDonator = 0
...
impulse.Config.DefaultTeam = TEAM_VISITOR
